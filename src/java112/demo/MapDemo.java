...
public class MapDemo {
  ...
  */
  ...
  public static void main(String[] args) {
	  ...
	  // use the containsValue method to check if a value is in the map
      if (map.containsValue(6)) {
          System.out.println("The value 6 is in the map");
      }

	  // use containsKey method to check if a key is in the map
	  ...
	  //Iterating over the map using a Set known as an Entry, which contains the key-value pair
